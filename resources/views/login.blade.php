        ...
        <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
            <div class="flex flex-col items-center overflow-y-auto md:flex-row">
                <div class="my-auto h-29 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="img/cover.jpg" />
                    <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="img/cover.jpg" />
                </div>
